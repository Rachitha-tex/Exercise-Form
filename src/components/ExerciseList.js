...
const Exercise = props => (
    <tr>
      ...
      <td>
        <Link to={"/edit/"+props.exercise._id} className="btn btn-primary">edit</Link> | <a href="#" onClick={() => { props.deleteExercise(props.exercise._id) }} className="btn btn-danger">delete</a>
      </td>
    </tr>
  )
